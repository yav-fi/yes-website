          ...
          >
            ...
            >
              ...
              <div className="flex flex-1 flex-col items-center justify-center px-6 pb-12">
                <div className="flex w-full max-w-sm flex-1 flex-col items-center justify-evenly text-center text-4xl font-semibold">
                  {links.map((l) => (
                    <NavLink
                      key={l.href}
                      href={l.href}
                      ...
                      onClick={() => setOpen(false)}
                      className="w-full text-4xl tracking-tight text-center"
                    />
                  ))}
